...
function modelName(input: any, output?: any) {
  return firstString(
    ...
    input?.metadata?.model?.providerID && input?.metadata?.model?.modelID ? `${input.metadata.model.providerID}/${input.metadata.model.modelID}` : null,
    input?.metadata?.model?.providerID && input?.metadata?.model?.id ? `${input.metadata.model.providerID}/${input.metadata.model.id}` : null,
    output?.metadata?.model?.providerID && output?.metadata?.model?.modelID ? `${output.metadata.model.providerID}/${output.metadata.model.modelID}` : null,
    output?.metadata?.model?.providerID && output?.metadata?.model?.id ? `${output.metadata.model.providerID}/${output.metadata.model.id}` : null,
    input?.state?.metadata?.model?.providerID && input?.state?.metadata?.model?.modelID ? `${input.state.metadata.model.providerID}/${input.state.metadata.model.modelID}` : null,
    input?.state?.metadata?.model?.providerID && input?.state?.metadata?.model?.id ? `${input.state.metadata.model.providerID}/${input.state.metadata.model.id}` : null,
    output?.state?.metadata?.model?.providerID && output?.state?.metadata?.model?.modelID ? `${output.state.metadata.model.providerID}/${output.state.metadata.model.modelID}` : null,
    output?.state?.metadata?.model?.providerID && output?.state?.metadata?.model?.id ? `${output.state.metadata.model.providerID}/${output.state.metadata.model.id}` : null,
    input?.metadata?.model?.modelID,
    input?.metadata?.model?.id,
    output?.metadata?.model?.modelID,
    output?.metadata?.model?.id,
    input?.state?.metadata?.model?.modelID,
    input?.state?.metadata?.model?.id,
    output?.state?.metadata?.model?.modelID,
    output?.state?.metadata?.model?.id,
    output?.model,
    output?.params?.model,
    output?.modelID,
    output?.modelId,
...
function extractParentSessionId(input: any, output: any) {
  return firstString(
    ...
    output?.parentSessionId,
    input?.metadata?.parentSessionID,
    input?.metadata?.parentSessionId,
    output?.metadata?.parentSessionID,
    output?.metadata?.parentSessionId,
    input?.state?.metadata?.parentSessionID,
    input?.state?.metadata?.parentSessionId,
    output?.state?.metadata?.parentSessionID,
    output?.state?.metadata?.parentSessionId,
...
function extractChildSessionId(input: any, output: any) {
  return firstString(
    ...
    output?.metadata?.sessionId,
    input?.state?.metadata?.sessionID,
    input?.state?.metadata?.sessionId,
    output?.state?.metadata?.sessionID,
    output?.state?.metadata?.sessionId,
