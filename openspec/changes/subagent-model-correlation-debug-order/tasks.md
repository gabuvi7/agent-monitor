...
- [x] 3.3 Refactor `public/app.js` debug/timeline formatting to parse entry blocks, reverse blocks, then apply filters.
...
- [x] 4.3 Browser-smoke multiline debug/timeline entries; verify newest-first order preserves each entry as one block.
